...
/* -----------------------------------------------------------------------------------------
  ...
  if (substr(basename($PHP_SELF), 0,13) != 'shopping_cart') { if ($_SESSION['customers_status']['customers_status_show_price'] == 1) { if (SET_BOX_CART == 'true') include(DIR_WS_BOXES . 'shopping_cart_pull.php'); } }
